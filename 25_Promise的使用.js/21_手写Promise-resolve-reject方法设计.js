...
class WHPromise {
  ...
  static resolve(value) {
    return new WHPromise((resolve) => resolve(value));
  }
  static reject(reason) {
    return new WHPromise((reject) => reject(reason));
  }
}
...
console.log("----------");
// WHPromise.resolve("123").then((res) => console.log(res));
WHPromise.reject("123").catch((err) => console.log(err));
